...
public static class SqlConnectionExtensions
{
    ...
    /// <returns></returns>
    public static async Task<DataTable> ExecuteQueryAsync(this SqlConnection sqlConnection, SqlQueryExpression query, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="query"></param>
    /// <returns></returns>
    public static DataTable ExecuteQuery(this SqlConnection sqlConnection, SqlQueryExpression query)
    {
        if (sqlConnection.State != ConnectionState.Open)
        {
            sqlConnection.Open();
